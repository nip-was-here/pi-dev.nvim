...
assert(output_text:find('#### Permission request: bash `git status', 1, true) == nil, output_text)
...
assert(output_text:find('#### Permission request: bash `' .. full_command, 1, true) == nil, output_text)
...
assert(output_text:find('Permission request: bash `python3', 1, true) == nil, output_text)
